...
from topo.bmatch import bmatch_with_requirements_interlayer, safe_greedy_bmatch
...
def _choose_action_from_state_eval(model: EdgeQNet, device: torch.device, amp_enabled: bool,
    ...
    E_t = bmatch_with_requirements_interlayer(
        scores=scores,
        max_deg=max_deg,
        E_core=state.E_core,
